...
const createUserRules = [
  ...
  body('role')
    .isIn(['admin', 'medium', 'read', 'telefonista', 'operador']).withMessage('Rol inválido'),
  body('full_name')
...
const updateUserRules = [
  ...
  body('role').optional().isIn(['admin', 'medium', 'read', 'telefonista', 'operador']).withMessage('Rol inválido'),
